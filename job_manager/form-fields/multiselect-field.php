...
<select multiple="multiple" name="<?php echo esc_attr( isset( $field['name'] ) ? $field['name'] : $key ); ?>[]" id="<?php echo esc_attr( $key ); ?>" class="job-manager-multiselect" <?php if ( ! empty( $field['required'] ) ) echo 'required'; ?> data-no_results_text="<?php pll_e( 'No results match', 'wp-job-manager' ); ?>" data-multiple_text="<?php pll_e( 'Select Some Options', 'wp-job-manager' ); ?>">
