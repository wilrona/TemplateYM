<form method="post" id="job_preview" action="<?php echo esc_url( $form->get_action() ); ?>">
	<div class="job_listing_preview_title">
		...
		<input type="submit" name="edit_job" class="button job-manager-button-edit-listing" value="<?php pll_e( 'Edit listing', 'wp-job-manager' ); ?>" />
		<h2><?php pll_e( 'Preview', 'wp-job-manager' ); ?></h2>
	</div>
