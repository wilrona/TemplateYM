<?php if ( is_user_logged_in() ) : ?>
	...
	<fieldset>
		<label><?php pll_e( 'Your account', 'wp-job-manager' ); ?></label>
		<div class="field account-sign-in">
			...
			<a class="button" href="<?php echo apply_filters( 'submit_job_form_logout_url', wp_logout_url( get_permalink() ) ); ?>"><?php pll_e( 'Sign out', 'wp-job-manager' ); ?></a>
		</div>
	</fieldset>
...
<?php else :
	...
	?>
	<fieldset>
		<label><?php pll_e( 'Have an account?', 'wp-job-manager' ); ?></label>
		<div class="field account-sign-in">
			<a class="button" href="<?php echo apply_filters( 'submit_job_form_login_url', wp_login_url( get_permalink() ) ); ?>"><?php pll_e( 'Sign in', 'wp-job-manager' ); ?></a>
